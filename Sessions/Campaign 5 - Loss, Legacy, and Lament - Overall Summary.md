...
- ~~House Modril's status as a major noble charitable house — with holdings, orphanages, and an active bloodline — sits oddly next to Magerna's own origin story, which establishes Magerna Modril the farmer as "the last of his line."~~ **Resolved** by a standalone GM lore dump: House Modril was founded by Marty, eldest of the orphaned children the farmer raised, not by blood descent — the House has never claimed descent from Magerna, nor has Magerna accepted membership within it. See [House Modril](../Factions/House%20Modril).
