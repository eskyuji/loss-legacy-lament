...
Leader of Lost Hope. An ancient, medieval-looking warrior whose metallic skin is the only thing that distinguishes him from a cosplayer in outdated armor — present when Lost Hope was little more than a fifty-foot patch of dirt. Has a steel arm, a Tychonium sword, and armor of Mykanonium. Makes deals with an Oathpact that forces truth from others in exchange for their freedom. Powerful, measured, and politically savvy. Implied to be the next Oathstone — confirmed in Campaign 5 as the Oathstone of Tenacity.

*⚠️ Naming note: an earlier compendium pass on this file and on [Oathstones](../Items/oathstones) spelled the name "Tin"; the Campaign 5 session transcripts consistently render it "Tyn" in dialogue (Bas himself hesitates over the pronunciation in Session 2 — "Am I remembering that name right? Rin?" — referring to the blade Reno/Rynn, see [Reno](../Items/reno)), and "Tyn" is confirmed as the correct spelling. A separate file was previously created under the "Tin" spelling; its content has been folded in here — see [Tin](tin) for the correction record.*
...
**Secondhand, via Thelonius.** Does not appear in person. Confirmed — beyond mere implication — to have become an Oathstone: Thelonius reveals that upon Tyn's ascension, his own sentient friend was transformed into a weapon, the Tychonium blade later known as Reno/Rynn, gifted to Bas roughly 2,000 years ago (see [Reno](../Items/reno)). Also confirmed as the namesake of Tychonium itself, the Volkan-forged metal — Thelonius personally witnessed him, while still mortal, dismantle a tyrannosaurus barehanded in about six seconds, "the reason the metal bears his name."
...
Met at the altar on Tyn Street in Lost Hope (the street is named for him). Gives Reno — his own Tychonium sword, worn down to almost nothing from centuries of use — to Bas Tetran XXIV without hesitation, just before the city is consumed by darkness around him (see [Reno](../Items/reno)). Separately, charges Varyn with refounding the Moa, setting up Varyn's introduction to the Frost Shepherds during downtime. His own line continues to point toward an eventual Oathstone reveal, as previously theorized in Campaign 3.

---

## Campaign 3 Session Detail

Arrives during the aftermath of the blood magic riot in Shaidar's Rest, declares Lost Hope's solidarity with the city, and uses his Oathpact to force the remaining blood-magic prisoners to answer truthfully in exchange for their freedom — permanently encasing them in aluminum afterward so they can never cast blood magic again. Executes some of the prisoners himself alongside Zeth Nogoth. Tells Myka that Lost Hope may need the Frost Shepherds' help in the future, and points to his metal arm as a hint that he, too, may become an Oathstone.
